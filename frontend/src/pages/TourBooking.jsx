...
export default function TourBooking() {
        ...
        <div className="booking-container">
          <div className="confirmation-box">
            ...
            <p className="success-message">
              Thank you, {formData.name}! Your tour has been successfully booked for {formData.date}.
            </p>
            ...
            <div className="agent-box">
              ...
              <p className="agent-message">
                Your agent will contact you within 24 hours to finalize all details.
              </p>
            </div>
            ...
            <button onClick={() => navigate("/city-selection")} className="btn-home">
              Return to Home
            </button>
          </div>
        </div>
  ...
  return (
    <div className="tour-booking-page">
      <div className="top-bar">
        <button className="back-btn" onClick={() => navigate("/lahore-sites")}>
          ← Back
        </button>
      ...
      <div className="booking-container">
        <form onSubmit={handleSubmit} className="booking-form">
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              <label>Choose Sites (Hold Ctrl/Cmd to select multiple) *</label>
              <select
                multiple
                size="8"
              ...
              >
                {allSites.map(site => (
                  <option key={site.id} value={site.id}>
                    {site.name} {site.fee > 0 ? `- Rs. ${site.fee}` : '- Free'}
                  </option>
                ))}
              </select>
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              ...
              <select
                ...
                required
              >
                <option value="none">No Transport (Self-Arranged) - Rs. 0</option>
                <option value="rickshaw">Rickshaw Service (2-3 people) - Rs. 1,500</option>
                <option value="car">Car/Sedan (4 people) - Rs. 3,000</option>
                <option value="van">Van/Coaster (8-15 people) - Rs. 5,000</option>
              </select>
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              ...
              <select
                ...
                required
              >
                <option value="full">Full Payment Now (10% Discount)</option>
          ...
          <div className="price-summary">
            ...
            <div className="summary-row">
              <span>Entry Fees ({selectedSitesData.length} sites):</span>
              <span>Rs. {prices.sitesFee}</span>
            </div>
            <div className="summary-row">
              <span>Tour Package:</span>
              <span>Rs. {prices.packageFee}</span>
            </div>
            <div className="summary-row">
              <span>Transportation:</span>
              <span>Rs. {prices.transportFee}</span>
            </div>
            <div className="summary-row subtotal">
              <span>Subtotal:</span>
              <span>Rs. {prices.subtotal}</span>
            </div>
            {prices.discount > 0 && (
              <div className="summary-row discount">
                <span>Discount (10%):</span>
                <span>- Rs. {prices.discount.toFixed(0)}</span>
              </div>
            )}
            <div className="summary-row total">
              <span>Total Amount:</span>
              <span>Rs. {prices.total.toFixed(0)}</span>
            </div>
          </div>
